...
### 🆕 ssh-key-audit.sh - SSH Key Hygiene Auditing
...
```json
{
  "timestamp": "2025-11-16T23:10:31+11:00",
  "home_root": "/home",
  "users_scanned": 5,
  ...
  "log_file": "/path/to/logs/ssh-key-audit/ssh_audit_20251116_231031.log"
}
```
...
2. **Duplicate detection bug:** Fixed substring matching (`grep -qF` → `grep -qFx`) - prevents false positives when key blobs are prefixes
